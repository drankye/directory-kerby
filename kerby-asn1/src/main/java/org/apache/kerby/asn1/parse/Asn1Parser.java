...
public class Asn1Parser {
    ...
    public static void parse(ParsingContainer container) throws IOException {
    ...
    public static void parse(Asn1Header header,
        ...
        while (true) {
            ...
            ParsingResult asn1Obj = parse(reader);
            if (asn1Obj == null) {
                break;
            }
    ...
    public static ParsingResult parse(Asn1Reader reader) throws IOException {
        if (!reader.available()) {
            return null;
        }
        ...
        if (tmpTag.isPrimitive()) {
            parsingResult = new ParsingItem(header);
        } else {
