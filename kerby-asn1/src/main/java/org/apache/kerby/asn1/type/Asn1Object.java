...
public abstract class Asn1Object implements Asn1Type {
    ...
    public void decode(ByteBuffer content) throws IOException {
        ParsingResult parsingResult = Asn1Parser.parse(content);
        decode(parsingResult);
    }

    public void decode(ParsingResult parsingResult) throws IOException {
    ...
    protected abstract void decodeBody(ParsingResult parsingResult) throws IOException;
    ...
    protected void taggedDecode(ParsingResult parsingResult,
                                TaggingOption taggingOption) throws IOException {
        ...
        if (taggingOption.isImplicit()) {
            ...
            ParsingResult body = container.getChildren().get(0);
            decode(body);
        }
    }
}
