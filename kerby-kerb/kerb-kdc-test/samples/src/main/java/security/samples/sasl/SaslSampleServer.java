...
public class SaslSampleServer extends SampleServer {
    ...
    protected void usage(String[] args) {
        if (args.length < 3) {
            System.err.println("Usage: java <options> SaslSampleServer "
                    + "<ListenPort> <service-protocol> <server-fqdn>");
            System.exit(-1);
        }
    }

    public SaslSampleServer(String[] args) throws Exception {
        super(args);
